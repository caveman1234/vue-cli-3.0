var config = {
  mode: 'production',
  context: '/Users/apple/web/vue/dr-ui',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: '/Users/apple/web/vue/dr-ui/dist',
  ...
  resolve: {
    ...
    modules: [
      'node_modules',
      '/Users/apple/web/vue/dr-ui/node_modules',
      '/Users/apple/web/vue/dr-ui/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
  ...
  module: {
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/apple/web/vue/dr-ui/node_modules/.cache/vue-loader',
              cacheIdentifier: '58da131d'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/Users/apple/web/vue/dr-ui/node_modules/mini-css-extract-plugin/dist/loader.js'
              },
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/apple/web/vue/dr-ui/node_modules/.cache/babel-loader',
              cacheIdentifier: '114d446b'
            }
          },
      ...
      /* config.module.rule('eslint') */
      {
        ...
        exclude: [
          /node_modules/,
          '/Users/apple/web/vue/dr-ui/node_modules/@vue/cli-service/lib'
        ],
        use: [
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        chunksSortMode: 'none',
        template: '/Users/apple/web/vue/dr-ui/public/index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/Users/apple/web/vue/dr-ui/public',
          to: '/Users/apple/web/vue/dr-ui/dist',
          ignore: [
            'index.html',
            '.DS_Store'
          ]
